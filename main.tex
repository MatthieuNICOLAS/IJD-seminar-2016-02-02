...
% TODO: Too many items on this slide, remove some
\begin{frame}{To a web app}{Chosen solution}
  \begin{itemize}
  \item {
  ...
  \item {
    ...
    \begin{itemize}
    \item User's actions are sent to server as JSON messages
    \end{itemize}
  }
  \item {
    Only need to implement an interpreter
    \begin{itemize}
    \item Parse and messages received from the client
    \item Query or command PLM-engine according to the message
    \item Send back result or ack to the client
    \end{itemize}
  }
  \end{itemize}
\end{frame}
