...
\begin{frame}{Assessment of user's code}{Architecture with judges}
  \begin{center}
    \begin{tikzpicture}[
      ...
      \node[right=2.5 of center-mq, opacity=0.6] (reply-mq-2) { \includegraphics[angle=90, scale=0.3]{img/message-queue-2.png} };

      \node[judge, below=1.5 of center-mq] (judge1) {Judge 1};
      \node[judge, right=0.5 of judge1] (judge2) {Judge 2};
